# Algorithms in JAVA
## 12.  Morris InOrder Tree Traversal Algorithm
```java
**
    ...
    public List<Integer> inorderTraversal(TreeNode root) {
        ...
        while(current_node!=null){
            if(current_node.left == null){
                ...
                TreeNode pre = current_node.left;
                while(pre.right != current_node && pre.right != null){
                    pre = pre.right;
                }
                if(pre.right == null){
...
```
## 11. Morris PreOrder Tree Traversal Algorithm
```java
/**
 * Definition for a binary tree node.
 * public class TreeNode {
...
```
## 10. Knuth Morris Patt algorithm `String Manipulation`
```java
...
```
## 8. Kandane's Algorithm `Dynamic Programming`
```java
...
```
## 7. Manacher's Algorithm `String Manipulation`
```java 
...
```
## 3. BubbleSort Algorithm `Sorting`
```java
import java.util.Scanner;
